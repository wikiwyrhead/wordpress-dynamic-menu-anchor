...
class Wiki_Dynamic_Heading_Anchors
{
    ...
    public function sanitize_settings($input)
    {
        ...
        // Sanitize scroll_offset
        $sanitized['scroll_offset'] = isset($input['scroll_offset']) ? absint($input['scroll_offset']) : 100;
        ...
        <div class="wrap wiki-dynamic-heading-anchors-settings">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row"><?php esc_html_e('Scroll Offset', 'wiki-dynamic-heading-anchors'); ?></th>
                        <td>
                            <input type="number" name="wiki_dynamic_heading_anchors_settings[scroll_offset]"
                                value="<?php echo esc_attr($this->settings['scroll_offset']); ?>" class="regular-text">
                            <p class="description"><?php esc_html_e('Scroll offset for menu items.', 'wiki-dynamic-heading-anchors'); ?></p>
                        </td>
                    </tr>
                </table>
                <?php submit_button(); ?>
...
<?php
    ...
    public function handle_add_to_menu_form_submission()
    {
        ...
        if (
            !isset($_POST['action']) || $_POST['action'] !== 'wiki_dynamic_heading_anchors_add_to_menu' ||
            ...
            foreach ($meta_keys as $key) {
                ...
                if (
                    ...
                    (strpos($key, 'section_title') !== false ||
                        ...
                        strpos($key, 'sub_heading') !== false ||
                        strpos($key, 'subheading') !== false) &&
                    strlen($meta_value) > 3 &&
    ...
    private function determine_heading_tag_from_field_name($field_name)
    {
        ...
        if (
            strpos($field_name, 'sub_title') !== false ||
            ...
            strpos($field_name, 'main_title') !== false ||
